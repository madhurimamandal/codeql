...
predicate should_override_eq_and_does_override_eq(ClassValue cls, Value base_eq) {
  cls.declaresAttribute("__eq__") and
...
where
  ...
  should_override_eq_and_does_override_eq(cls, base_eq) and
...
select cls,
  "The class '" + cls.getName() + "' overrides $@, adds new attribute $@.", base_eq,
