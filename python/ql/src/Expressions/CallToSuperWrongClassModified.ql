/**
 * @name Negative of First argument to super() is not enclosing class
  ...
  exists(GlobalVariable gv, ControlFlowNode cn |
    ...
    exists(ClassValue other |
      cn.pointsTo(other) and
       other.getScope().getName() = name
    )
  )
select call_to_super.getNode(), "First argument to super() is " + name + "."
